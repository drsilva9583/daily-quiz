...
A single-page, mobile-friendly quiz app that loads questions from `data.json`, selects a subject (based on day of week), shows a random starting question and then steps through questions sequentially. Includes animated UI, progress + score tracking, and support for multiple-choice and typed-answer questions.

## Features

- Subject-of-the-day (based on day of week)
...
Top-level object keyed by subject label. Each subject is an array of question objects.
